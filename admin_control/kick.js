...
{//<:warning_emote:559030535540834324>
	...
	if(taggedWarnedUser != undefined)
	{
		...
		client.setGuildPointerData.run(offendingUsersWarnFile)
	   	...
	   	message.delete().catch(err => {console.log("Recieved an error deleting a kick message. Ignorable, but also unknown.");});
	   	taggedWarnedUser.kick(outputReason);
	   	message.channel.send(`<:warning_emote:559030535540834324> <@${nextWarnArg}>, has been kicked`);
